    ...
    <div style={{ padding: '20px' }}>
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          <Campo texto="Código de Identificación" id="codigoIdentificacion" valor={codigoIdentificacion} setValor={setCodigoIdentificacion} />
          <Campo texto="Especie" id="especie" valor={especie} setValor={setEspecie} />
          <Campo tipo="date" texto="Fecha de Nacimiento" id="fechaNacimiento" valor={fechaNacimiento} setValor={setFechaNacimiento} />
          <div style={{ marginBottom: '10px' }}>
            <label htmlFor="sexo" style={labelStyle}>Sexo</label>
            <select id="sexo" value={sexo} onChange={(e) => setSexo(e.target.value)} style={inputStyle} required>
...
function Campo({ texto, id, valor, setValor, tipo = 'text' }) {
  return (
    <div style={{ marginBottom: '10px' }}>
      <label htmlFor={id} style={labelStyle}>{texto}</label>
      <input
        type={tipo}
        id={id}
        value={valor}
